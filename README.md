...
##  Project Overview
This system addresses the need for traffic management that can learn from historical patterns while strictly adhering to operational safety protocols. By combining Python for data processing and SWI-Prolog for rule-based logic, the system provides explainable routing recommendations without relying on third-party APIs.
